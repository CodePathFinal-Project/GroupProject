...
class QuestionnaireActivity : AppCompatActivity() {
    ...
    lateinit var periodLengthEt: EditText
    lateinit var cycleLengthEt: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        periodLengthEt = findViewById<EditText>(R.id.periodLengthEt)
        cycleLengthEt = findViewById<EditText>(R.id.cycleLengthEt)
        ...
        fetchPeriodAndCycleLength(user)
        ...
        saveBtn.setOnClickListener {
            ...
            periodLength = periodLengthEt.text.toString().toInt()
            cycleLength = cycleLengthEt.text.toString().toInt()
...
//        //Only return the periodAndCycleLength from the current user
    ...
    private fun fetchPeriodAndCycleLength(user: ParseUser) {
        ...
        query.findInBackground(object: FindCallback<UserPeriodAndCycleLength> {
            override fun done(
                usersPeriodAndCycleLength: MutableList<UserPeriodAndCycleLength>?,
                e: ParseException?
            ) {
                if (e != null) {
                    //Something went wrong
                    ...
                    if (usersPeriodAndCycleLength != null) {
                        ...
                        if (usersPeriodAndCycleLength.size == 1) {
                            currUserPeriodAndCycleLength = usersPeriodAndCycleLength[0]
                            periodLength = currUserPeriodAndCycleLength.getPeriodLength()
                            cycleLength = currUserPeriodAndCycleLength.getCycleLength()

                            periodLengthEt.setText(periodLength.toString())
                            cycleLengthEt.setText(cycleLength.toString())
                        }
                    }
                }
            }
